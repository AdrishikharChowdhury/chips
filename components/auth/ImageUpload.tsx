  ...
  return (
    <div className="space-y-3">
      <input
        ...
        className="form-input file:mr-4 file:rounded-none file:border-0 file:bg-cobalt-blue file:px-4 file:py-2 file:text-sm file:font-bold file:text-cream-paper"
      />
      {uploading && (
